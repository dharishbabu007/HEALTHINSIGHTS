CREATE OR REPLACE FORCE VIEW "MIPS"."MIPS_SUMMARY_VIEW" ("QUALITY_MEASURE_SK", "NUMERATOR", "DENOMINATOR", "RATIO", "PERIOD", "FACILITY_NAME", "OU_NAME", "CATEGORY_NAME", "PROGRAM_NAME", "MAX_POINTS", "MAX_SCORE", "MEASURE_TITLE", "P50", "P90", "LOCATION_SK", "LOCATION_NAME") AS 
