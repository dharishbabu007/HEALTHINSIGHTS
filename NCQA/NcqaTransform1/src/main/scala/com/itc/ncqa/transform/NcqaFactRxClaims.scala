...
import org.apache.spark.sql.functions.{abs, concat, current_timestamp, date_add, date_format, lit, when,expr}
...
object NcqaFactRxClaims {
  ...
  def main(args: Array[String]): Unit = {
    ...
    formattedfactRxClaimDf.write.mode(SaveMode.Overwrite).saveAsTable("ncqa_sample.FACT_RX_CLAIMS")
