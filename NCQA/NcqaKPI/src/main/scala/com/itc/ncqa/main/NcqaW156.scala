...
object NcqaW156 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val commonOutputFormattedDf = UtilFunctions.commonOutputDfCreation(spark, dinominatorDf, hospiceDf, w156NumeratorDf, numExclDf, outReasonValueSet, sourceAndMsrList)
