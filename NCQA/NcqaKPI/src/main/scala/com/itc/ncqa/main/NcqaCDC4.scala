...
object NcqaCDC4 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val commonOutputFormattedDf = UtilFunctions.commonOutputDfCreation(spark, dinominatorDf, dinominatorExclusionDf, cdc4NumeratorDf, numExclDF, outReasonValueSet, data_source)
