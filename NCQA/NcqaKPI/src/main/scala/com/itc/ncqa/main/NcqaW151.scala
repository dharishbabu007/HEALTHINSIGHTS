...
object NcqaW151 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val commonOutputFormattedDf = UtilFunctions.commonOutputDfCreation(spark, dinominatorDf, hospiceDf, w151NumeratorDf, numExclDf, outReasonValueSet, sourceAndMsrList)
