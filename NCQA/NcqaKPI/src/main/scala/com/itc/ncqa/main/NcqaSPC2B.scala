...
object NcqaSPC2B {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ageFilterDf = UtilFunctions.ageFilter(commonFilterDf, KpiConstants.dobColName, year, KpiConstants.age21Val, KpiConstants.age75Val, KpiConstants.boolTrueVal, KpiConstants.boolTrueVal)
    val genderFilterDf = ageFilterDf.filter(ageFilterDf.col(KpiConstants.genderColName).===("M"))
    ...
    val sourceAndMsrIdList = List(data_source,KpiConstants.spc2bMeasureId)
