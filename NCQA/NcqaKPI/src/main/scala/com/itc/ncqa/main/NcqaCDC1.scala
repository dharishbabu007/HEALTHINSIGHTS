...
object NcqaCDC1 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val cdc1DinominatorForKpiCalDf = dinominatorDf.except(dinominatorExclusionDf)
    ...
    val formattedOutPutDf = UtilFunctions.outputDfCreation(spark,dataDf,dinominatorExclusionDf,cdc1NumeratorDf,dimMemberDf,KpiConstants.cdcMeasureId)
