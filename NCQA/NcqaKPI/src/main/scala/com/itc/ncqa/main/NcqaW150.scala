...
object NcqaW150 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val commonOutputFormattedDf = UtilFunctions.commonOutputDfCreation(spark, dinominatorDf, hospiceDf, w150NumeratorDf, numExclDf, outReasonValueSet, sourceAndMsrList)
