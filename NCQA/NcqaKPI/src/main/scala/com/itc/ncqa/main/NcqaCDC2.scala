...
object NcqaCDC2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val commonOutputFormattedDf = UtilFunctions.commonOutputDfCreation(spark,dinominatorDf,dinominatorExclusionDf,cdc2NumeratorDf,numExclDf,outReasonValueSet,data_source)
