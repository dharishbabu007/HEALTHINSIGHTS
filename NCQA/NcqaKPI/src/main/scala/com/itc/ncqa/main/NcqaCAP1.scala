...
object NcqaCAP1 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ageFilterDf = UtilFunctions.ageFilter(commonFilterDf, KpiConstants.dobColName, year, KpiConstants.age1Val, KpiConstants.age2Val, KpiConstants.boolTrueVal, KpiConstants.boolTrueVal)
