...
<head>
	...
	//Worklist
	app.controller("MeasureCreateController", function($scope, $http, $location) {					
		...
		$scope.submitAdd = function () {
			$http.post('http://localhost:8081/curis/qms/work_list/', $scope.measureForm)		
			.then(function successCallback(response) {
				//$scope.measureForm = response.data;				
				console.log(response.statusText);
				_clearFormData();
				alert("Add measure creator success. ");
			}, function errorCallback(response) {
				console.log(response.statusText);
			});
		}
...
<body ng-app="QMSHomeManagement" ng-controller="MeasureCreateController">
    ...
    <div class="col-md-12 no-padding-margin">
        ...
        <div class="col-md-10 no-padding-margin main-content">
            ...
            <div class=" col-md-12 no-padding-margin" style="background-color: #fff;height: 60vh;overflow-y:scroll;">
               
    <div class="col-md-6" style="padding-top: 3vh;"><center>
	<form>
        <input ng-model="measureForm.programName" name="browser" class="form-group form-control drop-down drop-margin" placeholder="Program Name">
		<!--
        ...
        <input ng-model="measureForm.targetAge" name="browser" class="form-group form-control drop-down drop-margin" placeholder="Target Age">
        <datalist id="browsers">
            <option value="Internet Explorer">
            <option value="Firefox">
            <option value="Chrome">
        ...
        <input ng-model="measureForm.measureDomain" name="browser" class="form-group form-control drop-down drop-margin" placeholder="Measure Domian" >
        <datalist id="browsers">
            <option value="Internet Explorer">
            <option value="Firefox">
            <option value="Chrome">
        ...
        <input ng-model="measureForm.measureCategory" name="browser" class="form-group form-control drop-down drop-margin" placeholder="Measure Category" >
        <datalist id="browsers">
            <option value="Internet Explorer">
            <option value="Firefox">
            <option value="Chrome">
        ...
        <input ng-model="measureForm.type" name="browser" class="form-group form-control drop-down drop-margin" placeholder="Type" >
        <datalist id="browsers">
            <option value="Internet Explorer">
            <option value="Firefox">
            <option value="Chrome">
        ...
        <input ng-model="measureForm.clinocalCondition" name="browser" class="form-group form-control drop-down drop-margin" placeholder="Clinical Condition">
        <datalist id="browsers">
            <option value="Internet Explorer">
            <option value="Firefox">
            <option value="Chrome">
        ...
        <input ng-model="measureForm.target" name="browser" class="form-group form-control drop-down drop-margin" placeholder="Target">
    </center>
    </div>
    <div class="col-md-6" style="padding-top:3vh">
        <center>
        <input ng-model="measureForm.name" name="browser" class="form-group form-control drop-down drop-margin" placeholder="Measure Title">
        <input ng-model="measureForm.description" name="browser" class="form-group form-control drop-down drop-margin" placeholder="Description">
        <textarea ng-model="measureForm.denominator" class="form-control input_control form-group " rows="2" id="Denominator" type="text" placeholder="Denominator"></textarea>
        <textarea ng-model="measureForm.denomExclusions" class="form-control input_control form-group " rows="2" id="Denominator" type="text" placeholder="Denominator Exclusions"></textarea>
        <textarea ng-model="measureForm.numerator" class="form-control input_control form-group " rows="2" id="Denominator" type="text" placeholder="Numerator"></textarea>
        <textarea ng-model="measureForm.numeratorExclusions" class="form-control input_control form-group " rows="2" id="Denominator" type="text" placeholder="Numerator Exclusions"></textarea>
        ...
        <button ng-click="submitAdd()" class="btn btn-cls" style="background-color: #EFEFEF">Save</button> 
