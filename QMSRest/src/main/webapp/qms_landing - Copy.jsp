                ...
                <div class="col-md-12 sub-header">
                    ...
                    <form class="search-form" class="form-inline" role="form" method="post" action="/" target="_blank" >
                        <div class="input-group">
                            ...
                            <span class="input-group-btn"><button type="submit" class="btn btn-primary search-btn" data-target="#search-form" name="q" style="margin-top: 9px;padding: 0px;"><img src="images/SearchIcon.png" height= "33.5px">
                        </button></span>
                        </div>
                    </form>
                </div>
...
<!-- 
									...
									<td class="td-images">
									<a ng-href="QMS_measure_list.jsp#?type=Reimbursement&value={{program}}">
									<img src="images/ListView_icon.png" class="pull-right">
									</a>
									...
									<td class="td-images">
									<a 
									ng-href="QMS_measure_list.jsp#?type=Reimbursement&value={{program}}">
									<img src="images/ListView_icon.png" class="pull-right">
									</a>
									<a 
                        ...
                        <div class="div-content-box">
                            ...
                            <div class="border-box">
                                ...
                                <div class="tags">
									...
									<td class="td-images">
									<a ng-href="QMS_measure_list.jsp#?type=Clinical&value={{condition}}">
									<img src="images/ListView_icon.png" style="float:right;" >
									</a>
									</td>
									</tr>										
                            ...
                            <div class="border-box">
                                ...
                                <div class="tags">
                                   <!--  <ul>
									...
									<td class="td-images">
									<a ng-href="QMS_measure_list.jsp#?type=NQF&value={{domain}}">
									<img src="images/ListView_icon.png" style="float:right;"><br><br>
									</a>
									</td>
